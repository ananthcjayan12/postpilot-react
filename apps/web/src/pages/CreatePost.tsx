...
export function CreatePost() {
  ...
  const generateThumbnail = async () => {
    ...
    try { const result = await api.generateThumbnail(title, caption, youtubeFormat === 'short' ? 'vertical' : 'horizontal', referenceImage?.id, generatedThumbnailText || undefined, referenceMode, preserveReferenceBranding); setThumbnail(result); setGeneratedThumbnailText(result.thumbnailText); }
    catch (e: any) { setError(e.message); } finally { setBusy(''); }
  };
