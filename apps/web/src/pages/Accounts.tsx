...
export function Accounts() {
  ...
  return (
    <>
      <div className="page-heading"><div><span className="eyebrow">INTEGRATIONS</span><h1>Connected Accounts</h1><p>Authorize the official APIs once, then PostPilot can publish and schedule from your studio.</p></div><button className="btn secondary" onClick={refresh}><RefreshCw size={16} /> Refresh</button></div>
      {oauthError && <div className="alert danger">{oauthError}</div>}
      {connected && <div className="alert success"><CheckCircle2 size={17} /> Connection completed. Your account details are stored securely.</div>}
