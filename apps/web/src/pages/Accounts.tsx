...
const channelMeta: Record<Platform, { label: string; icon: any; description: string }> = {
  ...
  instagram: { label: 'Instagram', icon: Instagram, description: 'Publish to your linked Professional Instagram account.' },
  facebook: { label: 'Facebook', icon: Facebook, description: 'Publish videos and photos to your Facebook Page.' }
};
